...
namespace Tic_Tac_Toe_Game
{
   ...
   /// </summary>
    public partial class Game : Form
    {
        ...
        /// <summary>
        /// Checks for horizontal, vertical and diagonal wins and losses.
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Disables all buttons (to be used on opponent's turn).
        /// </summary>
        ...
        /// <summary>
        /// Enables all buttons (to be used on player's turn).
        /// </summary>
        ...
        private void ReceiveMove()
        {
            ...
            sock.Receive(buffer); //Waits for the opponent to play their move.
            if (buffer[0] == 1)
        ...
        {
            byte[] num = { 1 };
            sock.Send(num); // Sends the number of button clicked to the opponent.
